...
- [x] **Step 1: Write the failing Python contract test**
...
- [x] **Step 2: Run it and confirm the missing contract fails**
...
- [x] **Step 3: Write the contract schemas and prose contract**
...
- [x] **Step 5: Commit only the Python contract test**
...
- [x] **Step 1: Add failing safe-switch tests**
...
- [x] **Step 3: Implement the smallest safe rebuild result**
...
- [x] **Step 4: Run vector-store tests**
...
- [x] **Step 5: Commit the Python index safety change**
...
- [x] **Step 2: Run endpoint tests and confirm 404**
...
- [x] **Step 3: Add exact Pydantic schemas and route**
...
- [x] **Step 4: Run Python focused and quality checks**
...
- [x] **Step 5: Commit the Python API change without unrelated dirty files**
...
- [x] **Step 1: Add failing V19 and persistence tests**
...
- [x] **Step 2: Run the focused persistence tests**
...
- [x] **Step 3: Create V19 with database-enforced active-task uniqueness**
...
- [x] **Step 4: Implement Mapper operations**
...
- [x] **Step 6: Commit Java persistence**
...
- [x] **Step 1: Write failing authorization, transaction and coalescing tests**
...
- [x] **Step 2: Add dependencies and run the failing test**
...
- [x] **Step 3: Declare topology and properties**
...
- [x] **Step 4: Add Docker Compose RabbitMQ**
...
- [x] **Step 5: Run topology test and static Compose validation**
...
- [x] **Step 6: Commit broker topology**
...
- [x] **Step 1: Write failing confirm/nack/return tests**
...
- [x] **Step 3: Implement an enabled, bounded relay**
...
- [x] **Step 4: Run relay tests**

```powershell
.\mvnw.cmd -Dtest=AiTaskOutboxRelayTests test
```

- [x] **Step 5: Commit the relay**
...
- [x] **Step 1: Write failing propagation and idempotency tests**
...
- [x] **Step 3: Implement the long-task client**
...
- [x] **Step 4: Implement claim/lease and terminal transaction**
...
- [x] **Step 6: Commit worker and client**
...
- [x] **Step 1: Write failing retry and DLQ tests**
...
- [x] **Step 3: Implement failure classification and routing**
...
- [x] **Step 4: Implement Redrive transaction**
...
- [x] **Step 2: Run metric tests and confirm failure**

```powershell
.\mvnw.cmd -Dtest=ApplicationMetricsTests test
```

- [x] **Step 3: Add metrics at successful state boundaries**
...
- [x] **Step 4: Add dashboard panels and Runbook**
...
- [x] **Step 5: Validate tests and artifacts**
...
- [x] **Step 1: Add an opt-in real-process E2E test**
...
- [x] **Step 2: Run all focused Java and Python tests**
...
- [x] **Step 3: Run manual infrastructure verification**
...
- [x] **Step 4: Update status documentation with evidence only**
...
- [x] **Step 6: Commit Java fourth-week closure**
